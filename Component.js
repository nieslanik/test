...
jQuery.sap.require("test.dev.devapp");
jQuery.sap.require("test.MyRouter");
...
sap.ui.core.UIComponent.extend("test.Component", {
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("test");
		...
		var oModel;
		var externalURL = test.dev.devapp.externalURL;
		var appContext;
		if (test.dev.devapp.devLogon) {
			appContext = test.dev.devapp.devLogon.appContext;
		}
