jQuery.sap.declare("test.dev.devlogon");

sap.ui.base.ManagedObject.extend("test.dev.devlogon", {
	appContext: null,
	...
	constructor: function() {
		if (typeof test.dev.devlogon.__instance === "object") {
			return test.dev.devlogon.__instance;
		}
		test.dev.devlogon.__instance = this;
	},
